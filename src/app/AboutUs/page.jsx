...
function page() {
  ...
  <div className="mb-[160px] ml-[140px]">
    ...
    <h3 className="text-5xl font-extrabold bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent">
      FUELING YOUR<br/> SUCCESS
    </h3>

    <p className="text-white mt-5">
      Choose Triton Diesel Trading for your fuel supply<br/>
    ...
    CONTACT US
      ...
      <div>
        <div className='flex flex-col items-center mt-10'>
          ...
          <p className='max-w-2xl text-gray-600 leading-relaxed text-center'>Choose Triton Diesel Trading for your fuel supply needs and experience the<br/> difference.</p>
        </div>
  ...
  ✔
      ...
      <h3>Velit egestas dui id ornare. Aliquet eget sit amet tellus cras.</h3>
    </div>
  ...
  ✔
      ...
      <h3>
        Metus aliquam eleifend mi. In nulla posuere sollicitudin aliquam<br/>
  ...
  ✔
      ...
      <p className='text-gray-600'>Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut  enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut  aliquip<br/>
       ex ea commodo consequat. Duis aute irure dolor in reprehenderit  in voluptate velit esse cillum dolore eu fugiat nulla pariatur.  Excepteur sint occaecat<br/>
      ...
      <div>
        <div className='flex justify-around p-5 pl-20 gap-7 mt-20 '>
          <div>
            <h1 className='text-3xl md:text-4xl font-bold mb-4'>OUR M Ission</h1>
            <h3 className='text-[#ED683C] text-3xl '>The Best Fuel Solutions For<br/> Your Business</h3>
            <p className='mt-3 text-gray-600'>Lorem Ipsum is simply dummy text of the printing and typesetting industry.<br/> Lorem Ipsum has been the industry's. Lorem Ipsum is simply dummy text of the<br/> printing and typesetting industry. Lorem Ipsum has been the industry's .Lorem <br/>Ipsum is simply dummy text of the printing and typesetting industry. Lorem <br/>Ipsum has been the industry's </p>
          </div>
          <div className='relative'>
            <Image src={ourMissionImage}
            width={100}
            height={100}
      ...
      <div className='p-10'>
        <div className='flex flex-col items-center mt-20 text-center '>
          ...
          <p className='max-w-2xl text-gray-600 leading-relaxed text-center mb-6'>Lorem Ipsum is simply dummy text of the printing and typesetting industry.<br/> Lorem Ipsum has  been the industry's</p>
        </div>
