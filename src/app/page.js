  ...
  <div className="relative bg-[#F3903F] overflow-hidden">
    ...
    <div className="flex flex-col lg:flex-row items-center justify-between p-10 gap-8">
      <div className="max-w-lg text-white">
       ...
       Lorem Ipsum is simply dummy text of the printing and typesetting<br/> industry. Lorem Ipsum has been the industry's. Lorem Ipsum is simply<br/> dummy text of the printing and typesetting industry. Lorem Ipsum <br/>has been the industry's .
        </p>
...
<div className="flex justify-center gap-2 mt-6">
    ...
    <div className='flex justify-center align-items-center gap-5 items-center p-20'>
      <div>
        ...
        <h2 className=' text-xl text-orange-500 font-semibold'>THE BEST FUEL SOLUTIONS FOR<br/> YOUR BUSINESS</h2>
        <p className='text-gray-600 leading-relaxed '>Lorem Ipsum is simply dummy text of the printing and typesetting industry.<br/> Lorem Ipsum has been the industry's. Lorem Ipsum is simply dummy text of the<br/> printing and typesetting industry. Lorem Ipsum has been the industry's .Lorem <br/> Ipsum is simply dummy text of the printing and typesetting industry. Lorem <br/>Ipsum has been the industry's </p>
      </div>
      <div className='relative'>
        <Image 
        src={OurMission}
