      ...
      <div className="relative w-full h-[650px]">
        ...
        <div className="absolute bottom-60 left-75">
          ...
          <p className="text-white mt-5">
            ...
            <br /> products of the highest quality to our valued customers in
            the <br />
            UAE.
          </p>
        </div>
        ...
        <div className="flex justify-center gap-10 mt-20 items-center">
          ...
          <div>
            <h1 className="text-gray-600">
              ...
              has been the industry's. Lorem Ipsum is simply
              <br /> dummy text of the printing and typesetting <br />
              industry.{" "}
            </h1>
          </div>
        </div>
            ...
            <div className="border-1 border-gray-300 p-3 ">
              <div>
                ...
                <p className="text-gray-600">
                  ...
                  printing and typesetting industry. Lorem Ipsum <br /> has been
                  the industry's.
                </p>
              </div>
            </div>
