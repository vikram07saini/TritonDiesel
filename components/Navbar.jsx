      ...
      <div className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto flex justify-between items-center px-6 py-3">
          ...
          <ul className="hidden md:flex gap-10 items-center">
            ...
            <button className="bg-[#00A651] text-white px-6 py-2.5 rounded-full text-sm font-semibold tracking-wide transition-all duration-300 hover:bg-green-700 hover:shadow-lg hover:scale-105">
              FIND OUR LOCATIONS
            </button>
          </ul>
